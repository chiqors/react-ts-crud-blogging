    ...
    <div className="flex flex-col space-y-2 mb-5">
      <div className="flex items-center space-x-2">
        ...
        <input 
          ...
          className="w-full border border-gray-300 rounded-md py-2 px-4 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent" placeholder="Add a comment..." />
      </div>
      <button 
